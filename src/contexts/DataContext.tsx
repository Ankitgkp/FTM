  ...
  const fetchData = async () => {
    try {
      ...
      if (!isConnected || (!firstDataReceived && !isConnected)) {
        // First time getting data or reconnecting after disconnection
      ...
      // Update sensor data
      setSensorData(data);
      setPreviousConnectionState(isConnected); // Save current state before updating
      setIsConnected(true);
      ...
      // Check for disconnection - only when we were previously connected
